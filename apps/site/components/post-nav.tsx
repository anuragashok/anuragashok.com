      ...
      <div>
        {prev && (
          <Link href={`/writing/${prev.slug}`} className="group block">
            <span className="font-mono text-[length:var(--text-meta)] tracking-[0.12em] text-[var(--muted)]">NEWER</span>
      ...
      <div className="sm:text-right">
        {next && (
          <Link href={`/writing/${next.slug}`} className="group block">
            <span className="font-mono text-[length:var(--text-meta)] tracking-[0.12em] text-[var(--muted)]">OLDER</span>
